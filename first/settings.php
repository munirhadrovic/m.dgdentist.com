<?php
	$adresa="2025 75th Street | Woodridge, IL  60517"; //jako je vazno navesti dobro adresu radi boljeg poziciniranja
	$grad="";//jako je vazno ako adresa ima dva imena povezati ih sa plus
	$skracenica=""; // AKo ne znate skracenicu ostavite praznu
	$telephone=6309694413 ;// Broj koji se poziva na dugme CALL US
